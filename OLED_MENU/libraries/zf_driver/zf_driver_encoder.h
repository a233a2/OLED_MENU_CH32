 ...
 * @date            2021-11-25
 *                  V1.1 2022.02.13 修复encoder_channel_enum中枚举体定义问题
 ********************************************************************************************************************/
...
typedef enum    //TIMER引脚枚举
{
    ...
    //----------定时器4----------
    TIM4_CH1_ENCOEDER_B6  = 0x3000+32*1+6,     TIM4_CH2_ENCOEDER_B7    = 0x0000+32*1+7,      //默认引脚
    TIM4_CH1_ENCOEDER_D12 = 0x3100+32*3+12,    TIM4_CH2_ENCOEDER_D13   = 0x0000+32*3+13,     //重定向

    //----------定时器5----------
    TIM5_CH1_ENCOEDER_A0  = 0x4000+32*0+0,     TIM5_CH2_ENCOEDER_A1    = 0x0000+32*0+1,      //默认引脚
