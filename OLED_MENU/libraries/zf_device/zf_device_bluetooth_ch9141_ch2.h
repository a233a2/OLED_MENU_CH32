...
#define BLUETOOTH_CH9141_INDEX_CH2              UART_2                                      // 蓝牙模块 1 对应使用的串口号
#define BLUETOOTH_CH9141_BUAD_RATE_CH2          115200                                      // 蓝牙模块 1 对应使用的串口波特率
#define BLUETOOTH_CH9141_TX_PIN_CH2             UART2_RX_D6                                 // 蓝牙模块 1 对应模块的 TX 要接到单片机的 RX
#define BLUETOOTH_CH9141_RX_PIN_CH2             UART2_TX_D5                                 // 蓝牙模块 1 对应模块的 RX 要接到单片机的 TX
#define BLUETOOTH_CH9141_RTS_PIN_CH2            E10                                         // 蓝牙模块 1 对应模块的 RTS 引脚
