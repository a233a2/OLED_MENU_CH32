...
#define SCC8660_D1_PIN_DVP         	A10
#define SCC8660_D2_PIN_DVP         	C8
#define SCC8660_D3_PIN_DVP         	C9
#define SCC8660_D4_PIN_DVP         	C11
...
extern uint16  scc8660_image_dvp[SCC8660_DVP_PIC_H][SCC8660_DVP_PIC_W];

extern volatile uint8  scc8660_finish_flag_dvp;       // 一场图像采集完成标志位

extern uint8   scc8660_uart_receive_dvp[3];
extern uint8   scc8660_uart_receive_num_dvp;
extern volatile uint8  scc8660_uart_receive_flag_dvp;
...
void      dvp_seekfree_sendimg_scc8660(uart_index_enum uartn, uint8 *image, uint16 width, uint16 height);
